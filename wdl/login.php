...
<head>
	...
	<form method="POST" action="register.php">
	    		...
	    		<label for="Roll NO."><b>Email ID</b></label>
	    		<input type="text" placeholder="Enter Email" name="Roll NO." required>
			    ...
			    <center>
			    		<button type="submit" class="signupbtn">
			    			<a style="font-style: bold"><i class="fas fa-arrow-right"></i></a>
			    		</button>
				</center>
	</form>
	<br><br>
				...
				<center>
				    <p><h4><a href="fp.php" style="color: black"> Forgot Password?</h4></a>
				    <br>
				</center>
